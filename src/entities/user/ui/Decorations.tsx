      ...
      <Section title="Тема">
        <Tabs defaultValue={theme} variant="pill" onValueChange={setTheme}>
          <TabsList className="w-full flex border">
            <TabsTrigger value="system" classNameWrapper="flex-1 flex items-center justify-center">Системная</TabsTrigger>
            <TabsTrigger value="light" classNameWrapper="flex-1 flex items-center justify-center">Светлая</TabsTrigger>
            <TabsTrigger value="dark" classNameWrapper="flex-1 flex items-center justify-center">Темная</TabsTrigger>
          </TabsList>
