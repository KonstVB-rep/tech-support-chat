...
export const sendPushToProfile = async (profileId: string, payload: PushPayload) => {
  ...
  try {
    const subscription = profile.pushSubscription as unknown as webpush.PushSubscription
