...
export const useChatStore = create<ChatState>()(
  persist(
    (set) => ({
      ...
      clearOrganization: () =>
        set({ currentOrganizationId: null, currentMemberRole: null }),
    }),
    {
...
const selectCurrentOrganizationId = (state: ChatState) =>
  state.currentOrganizationId;
const selectCurrentMemberRole = (state: ChatState) => state.currentMemberRole;
const selectSetCurrentOrganization = (state: ChatState) =>
  state.setCurrentOrganization;
