...
import { EmployeeWithProfile, updateEmployeeFormSchema, UpdateEmployeeFormValues } from "@/entities/employee";
...
export const UpdateEmployee = ({
  ...
  return <UpdateEmployeeForm formAction={handleFormAction} form={form} isPending={isPending} />
};
        ...
        <CardContent>
            <FieldGroup>
             <div className="grid gap-1">
              <span>Email:</span>
              <span className="field-height flex items-center bg-muted rounded-lg p-2">{form.getValues("email")}</span>
             </div>  

             <div className="grid gap-1">
              <span>Имя:</span>
              <span className="field-height flex items-center bg-muted rounded-lg p-2">{form.getValues("name")}</span>
             </div>  


             <div className="grid gap-1">
              <span>Телефон:</span>
              <span className="field-height flex items-center bg-muted rounded-lg p-2">{form.getValues("phone")}</span>
             </div>  
              ...
              {role === USER_ROLE.ADMIN && <Controller
                name="role"
                control={form.control}
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
