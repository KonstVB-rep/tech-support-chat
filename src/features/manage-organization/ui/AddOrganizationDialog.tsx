...
import { FormSchemaOrganizationType, formSchemaOrganization } from '@/entities/organization';
...
export const AddOrganizationDialog = () => {
      ...
      const [state, formAction, isPending] = useActionState(addOrganizationAction, initialState);
  ...
  return (
    <Dialog>
        <DialogTrigger asChild>
          <Button variant="outline" size="icon" title="Добавить организацию" className='m-0'><Plus /></Button>
        </DialogTrigger>
        <DialogContent className="sm:max-w-lg m-0">
          ...
          <FieldGroup>
            <OrganizationForm form={form} formAction={handleFormAction} isPending={false} title="Добавить организацию" submitText="Добавить" />
          </FieldGroup>
        </DialogContent>
    </Dialog>
  )
