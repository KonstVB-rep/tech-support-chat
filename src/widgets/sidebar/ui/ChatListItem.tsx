  ...
  return (
    ...
    >
      ...
      <Avatar className="w-11 h-11 border border-border/20 shrink-0">
        ...
        <AvatarFallback className={cn("font-bold", isActive ? "bg-primary-foreground/20 text-primary-foreground" : "bg-muted text-muted-foreground")}>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-1">
          ...
          <span className={cn("text-[10px] shrink-0", isActive ? "text-primary-foreground/60" : "text-muted-foreground")}>
            {timestamp}
          </span>
        </div>
