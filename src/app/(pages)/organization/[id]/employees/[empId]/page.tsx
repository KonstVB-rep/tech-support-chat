...
const EmployeeSinglePage = async ({ params }: { params: Promise<{ empId: string }> }) => {
  ...
  return (
    <div className="flex h-full w-full flex-col">
      <WrapperHeaderScreen>
        <h2 className="w-full text-center font-semibold uppercase">Сотрудник</h2>
      </WrapperHeaderScreen>
      <div className="grid grid-cols-1 gap-4 p-3">
        <Profile id={empId} />
        <ProtectByRole>
          {organizations.length > 0 && (
            <div className="max-h-1/2 min-h-full space-y-3 overflow-y-auto p-3">
