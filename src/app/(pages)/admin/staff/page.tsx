...
import StaffDataStream from "@/app/(pages)/admin/staff/ui/StaffDataStream"
import { AddStaffMemberDialog } from "@/features/manage-staff"
    ...
    <div className="h-full w-full space-y-3">
      <WrapperHeaderScreen>
        <div className="flex w-full items-center justify-between px-2">
          <ButtonBack />
          <h2 className="flex-1 text-center font-semibold uppercase">Сотрудники техподдержки</h2>
